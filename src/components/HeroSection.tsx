...
const HeroSection = () => {
  ...
  return (
    <section className={`min-h-screen flex items-center justify-center bg-gradient-to-b from-background to-secondary/30 px-6 pt-24 md:pt-20 ${getLanguageClass()}`}>
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="text-center lg:text-left space-y-8">
          <div className="space-y-4">
            ...
            <p className="subtitle-responsive text-muted-foreground max-w-lg">
              {t('hero.subtitle')}
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
            <Button 
              ...
              className="btn-responsive text-lg px-8 py-6 rounded-xl"
            >
              {t('cta.bookCall')}
            </Button>
            <Button 
              ...
              className="btn-responsive text-lg px-8 py-6 rounded-xl sm:ml-5"
            >
              {t('cta.seePrices')}
            </Button>
          </div>

          <p className="text-sm text-muted-foreground border border-border rounded-lg p-4 bg-secondary/50 text-responsive">
            {t('cta.noPayments')}
          </p>
        </div>
